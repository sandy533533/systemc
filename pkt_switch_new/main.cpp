...
sc_main(int, char *[])
{
  ...
  switch_top switch_top0("SWITCH_TOP");

  switch_top0.switch_cntrl(switch_cntrl);
  switch_top0.in0(pkt_in0);
  switch_top0.in1(pkt_in1);
  switch_top0.in2(pkt_in2);
  switch_top0.in3(pkt_in3);

  switch_top0.out0(pkt_out0);
  switch_top0.out1(pkt_out1);
  switch_top0.out2(pkt_out2);
  switch_top0.out3(pkt_out3);
